...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Descargando código de WADO...${GRAY_LIGHT}"
  printf "\n\n"
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos a actualizar el sistema WADO...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos a eliminar el WADO....${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a bloquear el WADO....${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos a desbloquear el WADO....${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos a cambiar los dominios del WADO...${GRAY_LIGHT}"
  printf "\n\n"
...
system_certbot_setup() {
  print_banner
  printf "${WHITE} 💻 Configurando certbot, ya estamos cerca del final...${GRAY_LIGHT}"
  printf "\n\n"
